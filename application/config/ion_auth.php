 ...
 */
$config['site_title']                 = "siska.sman5madiun.sch.id";       // Site Title, example.com
$config['admin_email']                = "admin@sman5madiun.sch.id"; // Admin Email, admin@example.com
...
$config['recheck_timer']              = 1;                   /* The number of seconds after which the session is checked again against database to see if the user still exists and is active.
